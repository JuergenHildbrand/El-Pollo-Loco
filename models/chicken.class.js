class Chicken extends MovableObject {
    ...
    constructor() { 
        ...
        this.x = 1600 + Math.random() * 5000; // this.x = at least 1600 + a random number between 0 and 1, times 6000 (a number between 1600 and 7600)
        this.speed = 0.2 + Math.random() * 2; // The chicken gets a different speed
        this.animate();
    }
